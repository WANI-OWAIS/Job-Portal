          ...
          <table className="w-full max-w-4xl bg-white border border-gray-300 border-collapse max-sm:text-sm">
            <thead>
              <tr>
                ...
                <th className="py-2 px-4 text-left border border-gray-300 max-sm:hidden">
                  Job Title
                </th>
                <th className="py-2 px-4 text-left border border-gray-300 max-sm:hidden">
                  Location
              ...
              {applicants
                ...
                .map((applicant, index) => (
                  <tr key={index} className="text-gray-700">
                    ...
                    <td className="py-2 px-4 border border-gray-300 text-center flex items-center">
                      <img
                    ...
                    <td className="py-2 px-4 border border-gray-300 max-sm:hidden">
